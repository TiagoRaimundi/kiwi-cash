...
export default function Hero({ onRegisterClick }: HeroProps) {
  return (
    <>
      ...
      >
        {/* Decorative elements - Mais presentes e distribuídos */}
        {/* Lado direito */}
        <div
          style={{
            position: "absolute",
        ...
        <div
          ...
          className="animate-float-delayed-1"
        >
          🥝
        </div>
        <div
        ...
        <div
          ...
          className="animate-float-delayed-half"
        >
          🥝
        </div>
        <div
          ...
          className="animate-float-delayed-1-5"
        >
          🥝
        </div>
        <div
          ...
          className="animate-float-delayed-2-5"
        >
          🥝
        </div>
        <div
          ...
          className="animate-float-delayed-3"
        >
          🥝
        </div>
